                    ...
                    <ul class="cl">
                        ...
                        <li class="dropDown dropDown_hover">
                            ...
                            <ul class="dropDown-menu menu radius box-shadow">
                                ...
                                <li><a href="#">切换账户</a></li>
                                <li><a href="{{route('adminloginout')}}">退出</a></li>
                            </ul>
                        </li>
    ...
    <aside class="Hui-aside">
        <div class="menu_dropdown bk_2">
            <dl id="menu-system">
                ...
                <dd>
                    <ul>
                        <li><a data-href="{{route('set')}}" data-title="系统设置" href="javascript:void(0)">系统设置</a></li>
                        <li><a data-href="{{route('menu')}}" data-title="栏目管理" href="javascript:void(0)">菜单管理</a></li>
            ...
            @if(!empty($category))
                @foreach($category as $k => $v)
                    <dl id="menu-{{$v['url']}}">
                        <dt><i class="Hui-iconfont"><?php echo !empty($v['icon']) ? $v['icon'] : '&#xe620;'?></i> {{$v['name']}}<i class="Hui-iconfont menu_dropdown-arrow">&#xe6d5;</i>
                        </dt>
                        @if(isset($v['list']) && !empty($v['list']))
                            <dd>
                                <ul>
                                    @foreach($v['list'] as $value)
                                        <li><a data-href="{{!empty($value['url']) ? route($value['url']) :'javascript:void(0)'}}" data-title="{{$value['name']}}" href="javascript:void(0)">{{$value['name']}}</a></li>
                                    @endforeach
                                </ul>
                            </dd>
                        @endif
    ...
    <section class="Hui-article-box">
        <div id="Hui-tabNav" class="Hui-tabNav hidden-xs">
            <div class="Hui-tabNav-wp">
                <ul id="min_title_list" class="acrossTab cl">
                    <li class="active">
                        <span title="我的桌面" data-href="{{route('Awelcome')}}">我的桌面</span>
                        <em></em></li>
                </ul>
            </div>
        ...
        <div id="iframe_box" class="Hui-article">
            <div class="show_iframe">
                ...
                <iframe scrolling="yes" frameborder="0" src="{{route('Awelcome')}}"></iframe>
            </div>
        </div>
    </section>
